...
config.refreshLookupSet = function () {
    if (config.lookup) {
        ...
        config.lookup.forEach(function (trackedMethod) {
            ...
            if (typeof instruments.lookupMap[trackedMethodString] !== "undefined") {
                if (trackedMethod.selected === false) {
                    delete instruments.lookupMap[trackedMethodString];
                }
                else
                    instruments.lookupMap[trackedMethodString] = trackedMethod;
            } 
