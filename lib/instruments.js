...
var instruments = {
    ...
    getFunctionGivenName: function(filename, lineNumber) {
        var func = this.lookupMap.get(filename + config.methodSignatureSeparator + lineNumber);
    ...
    prepareLogMessage: function(logObject, direction) {
        ...
        if ((logObject.funcText !== 'An anonymous function ') && (logObject.funcText !== 'anonymous_function')) {
            if (typeof that.lookupSet[logObject.filename +
                    config.methodSignatureSeparator + logObject.lineNumber] !== "undefined" ) {
    ...
    postBackLog: function(logObject) {
        return;var logObjectString = JSON.stringify(logObject);
