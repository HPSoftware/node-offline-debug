...
var instruments = {
    ...
    prepareLogTexts: function(name, argsNames, args, filename, lineNumber, timestamp, flowId) {
        var that = this,
    ...
    // Format output
    prepareLogMessage: function(logObject) {
        var formattedMessage = '';

        formattedMessage =
            logObject.filename + ' call ' + 
            logObject.funcName + '(' + logObject.argsNames + ') -> ' + 
            logObject.argsText + ' line#: ' + logObject.lineNumber + 
            ', flowId: ' + logObject.flowId;
