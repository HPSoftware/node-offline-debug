...
var instruments = {
    ...
    prepareLogMessage: function(logObject, direction) {
        ...
        if ((logObject.funcText !== 'An anonymous function ') && (logObject.funcText !== 'anonymous_function')) {
            if (that.lookupSet.contains(logObject.filename + 
                    config.methodSignatureSeparator + logObject.lineNumber)) {
    ...
    postBackLog: function(logObject) {
        ...
        var rawConfig = '',
            ...
            options = config.createHttpOptions("POST", additionalHeaders);
