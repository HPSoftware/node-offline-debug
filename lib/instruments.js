...
var instruments = {
    ...
    handlePreMessage: function(name, args, moduleName, start, methodId, line_number) {
        // TODO: MUST have a check here if this method is actually being debugged
    ...
    handlePostMessage: function(name, result, moduleName, methodId) {
        // TODO: MUST have a check here if this method is actually being debugged
        var log = this.prepareLogTextsEnd(name, result, moduleName);
