...
var network = {
    ...
    setSettings: function (config) {
        this.settings['host'] = config.url;
        this.settings['url_getConfig'] = config.url_getFunctions;
        this.settings['url_postResults'] = config.url_postData;
    ...
    updateConfig: function (config, doUpdate) {
        var rawConfig = '',
            loadedConfig = {},
            that = this,
            options = network.createHttpOptions("GET", config.url, config.url_getFunctions);
        ...
        callback = function (response) {
            ...
            response.on('end', function () {
                var tmp = rawConfig;
                var loadedConfig = JSON.stringify(tmp);
